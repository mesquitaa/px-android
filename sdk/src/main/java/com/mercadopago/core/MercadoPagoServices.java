...
//        MPTracker.getInstance().trackEvents("NO_SCREEN", "GET_PREFERENCE", "3", mPublicKey, BuildConfig.VERSION_NAME, mContext);
...
//        MPTracker.getInstance().trackEvents("NO_SCREEN", "GET_INSTRUCTIONS", "1", mPublicKey, BuildConfig.VERSION_NAME, mContext);
        CheckoutService service = getDefaultRetrofit().create(CheckoutService.class);
...
//        MPTracker.getInstance().trackEvents("NO_SCREEN", "GET_PAYMENT_METHOD_SEARCH", "1", mPublicKey, BuildConfig.VERSION_NAME, mContext);
...
//        MPTracker.getInstance().trackEvents("NO_SCREEN", "CREATE_PAYMENT", "1", mPublicKey, BuildConfig.VERSION_NAME, mContext);
...
//        MPTracker.getInstance().trackEvents("NO_SCREEN", "CLONE_TOKEN", "1", mPublicKey, BuildConfig.VERSION_NAME, mContext);
        GatewayService service = getGatewayRetrofit().create(GatewayService.class);
...
//        MPTracker.getInstance().trackEvents("NO_SCREEN", "GET_BANK_DEALS", "1", mPublicKey, BuildConfig.VERSION_NAME, mContext);
...
//        MPTracker.getInstance().trackEvents("NO_SCREEN", "GET_IDENTIFICATION_TYPES", "1", mPublicKey, BuildConfig.VERSION_NAME, mContext);
...
//        MPTracker.getInstance().trackEvents("NO_SCREEN", "GET_INSTALLMENTS", "1", mPublicKey, BuildConfig.VERSION_NAME, mContext);
...
//        MPTracker.getInstance().trackEvents("NO_SCREEN", "GET_ISSUERS", "1", mPublicKey, BuildConfig.VERSION_NAME, mContext);
        PaymentService service = getDefaultRetrofit().create(PaymentService.class);
...
//        MPTracker.getInstance().trackEvents("NO_SCREEN", "GET_PAYMENT_METHODS", "1", mPublicKey, BuildConfig.VERSION_NAME, mContext);
        PaymentService service = getDefaultRetrofit().create(PaymentService.class);
...
//        MPTracker.getInstance().trackEvents("NO_SCREEN", "GET_DIRECT_DISCOUNT", "1", mPublicKey, BuildConfig.VERSION_NAME, mContext);
...
//        MPTracker.getInstance().trackEvents("NO_SCREEN", "GET_CODE_DISCOUNT", "1", mPublicKey, BuildConfig.VERSION_NAME, mContext);
        DiscountService service = getDefaultRetrofit().create(DiscountService.class);
...
//        MPTracker.getInstance().trackEvents("NO_SCREEN", "GET_CAMPAIGNS", "1", mPublicKey, BuildConfig.VERSION_NAME, mContext);
        DiscountService service = getDefaultRetrofit().create(DiscountService.class);
